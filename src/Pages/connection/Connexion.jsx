    ...
    <section className='connexion'>
      <div className='w-full relative'>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 lg:grid-cols-9">
          <div className="col-span-2 md:hidden lg:block h-full connexion-col-2 bg-green-color">
            <div className='absolute connexion-picture'>
              <img src={man} alt="" />
            </div>
          </div>
          <div className="col-span-3 md:col-span-3 pt-16 flex flex-col gap-y-10 bg-white">
            <ConnexionCard
