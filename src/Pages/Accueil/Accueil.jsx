            ...
            <main className='accueil'>
                ...
                <section className=' px-5 pt-10 pb-20 bg-white mt-10'>
                    <div>
                        ...
                        <div className="mini-card-connexion flex flex-wrap items-center justify-center w-full  gap-y-20">
                ...
                <section className=''>
                    <div className=' flex pt-28'>
                        ...
                        <div className='relative w-full bg-no-repeat bg-cover bg-left bg-phone' style={{ backgroundImage: `url(${phoneBg})` }}>
