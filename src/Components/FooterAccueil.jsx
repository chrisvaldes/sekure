    ...
    return (
        <div className='bg-green-color sm:py-10  footer-section'>
            <div className='relative footer-page grid grid-cols-1 lg:grid-cols-2'>
                ...
                <div className="relative lg:hidden footer-page-order-other flex items-center justify-center order-1 lg:order-2  w-full h-[350px]">
                    <div className="flex items-center justify-center absolute bottom-0 lg:left-0 w-full">
                        <img src={manFooter} alt="" className='w-[350px] h-[380px] sm:w-[482.12px] sm:h-[444px]' />
                    </div>
                </div>
                <img src={manFooter} alt="" className='womenFooter hidden lg:block absolute bottom-0 right-28 w-[482.12px] h-[444px] z-10' />
            </div>
